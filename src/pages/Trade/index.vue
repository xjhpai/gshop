<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="userAddress in userAddressList" :key="userAddress.id" @click="changeDefault(userAddress,userAddressList)">
  ...
  methods:{
    ...
    async submitOrder(){
      ...
      try {
        ...
        if(result.code === 200){
          this.$router.push(`/pay?trade=${result.data}`)
        }
      } catch (error) {
        alert(error.message)
      }
